 ...
 * the number of Calories contained by the various meals, snacks, rations, etc. that they've brought
 * with them, one item per line. Each Elf separates their own inventory from the previous Elf's
 * inventory (if any) by a blank line. For example, suppose the Elves finish writing their items'
 ...
 * 7000 8000 9000
 * <p>
 * 10000 This list represents the Calories of the food carried by five Elves: The first Elf is
 * carrying food with 1000, 2000, and 3000 Calories, a total of 6000 Calories. The second Elf is
 * carrying one food item with 4000 Calories. The third Elf is carrying food with 5000 and 6000
 * Calories, a total of 11000 Calories. The fourth Elf is carrying food with 7000, 8000, and 9000
